...
function loadPlayersPage(){
	...
	for(i = 0; i < players.length; i++){
		console.log(i);
		newItem.push(document.createElement("li"));
		anchor.push(document.createElement("a"));
		anchor[i].setAttribute("href", "#");
		anchor[i].setAttribute("onclick", "switchPlayers("+ i +")");
		anchor[i].innerHTML = players[i].name;
		div.appendChild(newItem[i]);
		newItem[i].appendChild(anchor[i]);
	}
}
...
function switchPlayers(playerNum){
	...
	document.getElementById('player_img').setAttribute("img", players[playerNum].img);
